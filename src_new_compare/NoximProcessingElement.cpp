...
int NoximProcessingElement::get_slice(NoximCoord src_coord, NoximCoord dest_coord){
	...
	if((src_coord.x == 1 && src_coord.y == 0)||(src_coord.x == 6 && src_coord.y == 0)
			||(src_coord.y == 1 && src_coord.x == 0)||(src_coord.y == 1 && src_coord.x == 7)
			||(src_coord.y == 6 && src_coord.x == 0)||(src_coord.y == 6 && src_coord.x == 7)
			||(src_coord.y == 7 && src_coord.x == 1)||(src_coord.y == 7 && src_coord.x == 6))
		mem_controller = true;
	//===================================================================
	if (mem_controller){
		return 0;
