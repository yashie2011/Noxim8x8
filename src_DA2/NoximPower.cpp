...
void NoximPower::Buffer_read()
{
	pwr += PWR_BUFF_READ;
}
void NoximPower::Buffering_half()
{
	pwr += PWR_BUFF_HALF ;
}
void NoximPower::Buffer_read_half()
{
	pwr += PWR_BUFF_READ_HALF;
}
...
void NoximPower::Arbitration_half()
{
	pwr += PWR_ARB_HALF;
}
