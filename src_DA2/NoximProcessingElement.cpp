    		...
    		if (req_rx[k].read() == 1 - current_level_rx[k]) {
    			    ...
    			    else
    			    {
    			    	if( flit_tmp.ack_msg == last_packet && flit_tmp.flit_type == FLIT_TYPE_HEAD )
    			    	{
    			    		...
    			    		start_clock = true;
    	   			    	//cout<<" Response recieved from MC: src_id == "<< flit_tmp.src_id<<" dest_id == "<<local_id<<endl;
...
int NoximProcessingElement::get_slice(NoximCoord src_coord, NoximCoord dest_coord){
	...
	if (is_mc(src_coord)){
		if(coord2Id(src_coord) == m1){
					//cout<<"source is ("<<src_coord.x <<" "<< src_coord.y <<")" << endl;
					switch(dest_coord.x){
					case 1:
						return 8; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 2:
						return 1; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 3:
						return 2; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 4:
						return 3; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 5:
						return 4; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 5; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 6; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 0:
						return 7; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
						return 0; //cout<< "Slice chosen is 4"<< endl;
						break;


					}
				}  // End of Mem_Controller 0
		if(coord2Id(src_coord) == m2){
					//cout<<"source is ("<<src_coord.x <<" "<< src_coord.y <<")" << endl;
					switch(dest_coord.x){
					case 1:
						return 7; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 2:
						return 8; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 3:
						return 1; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 4:
						return 2; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 5:
						return 3; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 4; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 5; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 0:
						return 6; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
						return 0; //cout<< "Slice chosen is 4"<< endl;
						break;
				...
				}  // End of Mem_Controller 1
		if(coord2Id(src_coord) == m3){
					//cout<<"source is ("<<src_coord.x <<" "<< src_coord.y <<")" << endl;
					switch(dest_coord.x){
					case 1:
						return 6; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 2:
						return 7; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 3:
						return 8; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 4:
						return 1; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 5:
						return 2; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 3; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 4; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 0:
						return 5; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
						return 0; //cout<< "Slice chosen is 4"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m4){
					//cout<<"source is ("<<src_coord.x <<" "<< src_coord.y <<")" << endl;
					switch(dest_coord.x){
					case 1:
						return 5; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 2:
						return 6; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 3:
						return 7; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 4:
						return 8; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 5:
						return 1; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 2; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 3; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 0:
						return 4; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
						return 0; //cout<< "Slice chosen is 4"<< endl;
						break;
