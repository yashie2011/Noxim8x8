...
// reply network 16 bit channel with 2 vcs per channel, 2 buffer per vc
#define PWR_BUFF_HALF 4.17e-13
#define PWR_BUFF_READ_HALF 1.18e-13
#define PWR_ARB_HALF 2.1e-13
#define PWR_CROSS_HALF 1.9e-13

#define PWR_BUFF_FULL 11.4e-12
#define PWR_BUFF_READ 9.7e-12
#define PWR_ARB_FULL 3.4e-13
#define PWR_CROSS_FULL 1.5e-12
...
class NoximPower {
  ...
  public:
    ...
    void Buffer_read();
    void Buffering_half();
    void Buffer_read_half();
    void Routing();
    void Selection();
    void Arbitration();
    void Arbitration_half();
    void Crossbar();
    void Crossbar_half();
