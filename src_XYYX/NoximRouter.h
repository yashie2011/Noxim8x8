...
extern double slice_0[4][4][5];
extern double slice_1[4][4][5];
SC_MODULE(NoximRouter)
{
    ...
    /*sc_out <double> time_stamp_out[DIRECTIONS + 1];
    sc_out <double> time_stamp_in[DIRECTIONS + 1];
    ...
    bool compare_time_stamps(int i);
    // Constructor
  ...
  private:
    ...
    vector < int >routingYX(const NoximCoord & current,
			    const NoximCoord & destination);
