...
// Reply router is a fast router
// Request router is a 2 stage router with only 2 stages

#define PWR_BUFF_FULL 5.4e-12
#define PWR_BUFF_READ 9.65e-13
#define PWR_ARB_FULL 2.31e-13
#define PWR_CROSS_FULL 1.58e-12
