...
void NoximNoC::gam()   //needs change while expanding
{
	...
	MC8_time = 5;
		...
		if(gam_counter >= GAM_COMPUTE_TIME){
			...
			mc_size.push_back(t[id2Coord(m5).x][id2Coord(m5).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m6).x][id2Coord(m6).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m7).x][id2Coord(m7).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m8).x][id2Coord(m8).y]->pe->get_reply_queue_size()) ;
			...
			mc_reqs.push_back(t[id2Coord(m5).x][id2Coord(m5).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m6).x][id2Coord(m6).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m7).x][id2Coord(m7).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m8).x][id2Coord(m8).y]->pe->get_num_reqs()) ;
			...
			uint ratio1, ratio2, ratio3, ratio4, ratio5, ratio6, ratio7, ratio8;
			...
			if(min_score >0 ){
				...
				ratio5 = gam_scores[4]/(min_score);
				ratio6 = gam_scores[5]/(min_score);
				ratio7 = gam_scores[6]/(min_score);
				ratio8 = gam_scores[7]/(min_score);

				int tot_time_window = 5 * MEM_CONTROLLERS;
				MC1_time = floor(tot_time_window*ratio1/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC2_time = floor(tot_time_window*ratio2/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC3_time = floor(tot_time_window*ratio3/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC4_time = floor(tot_time_window*ratio4/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC5_time = floor(tot_time_window*ratio5/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC6_time = floor(tot_time_window*ratio6/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC7_time = floor(tot_time_window*ratio7/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				MC8_time = floor(tot_time_window*ratio8/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8));
				...
				t[id2Coord(m5).x][id2Coord(m5).y]->pe->reset_num_reqs();
				t[id2Coord(m6).x][id2Coord(m6).y]->pe->reset_num_reqs();
				t[id2Coord(m7).x][id2Coord(m7).y]->pe->reset_num_reqs();
				t[id2Coord(m8).x][id2Coord(m8).y]->pe->reset_num_reqs();
...
void NoximNoC::enable_mcs(){
	if(reset.read()){
		...
		t[id2Coord(m5).x][id2Coord(m5).y]->fcr->reset_send_enable();
		t[id2Coord(m6).x][id2Coord(m6).y]->fcr->reset_send_enable();
		t[id2Coord(m7).x][id2Coord(m7).y]->fcr->reset_send_enable();
		t[id2Coord(m8).x][id2Coord(m8).y]->fcr->reset_send_enable();

		//t[id2Coord(1).x][id2Coord(1).y]->fcr->set_fast_line(0);
		//t[id2Coord(6).x][id2Coord(6).y]->fcr->set_fast_line(1);
	...
	if(enable_timer < 5 * MEM_CONTROLLERS){
		if((enable_timer >= 0) && (enable_timer < MC1_time)){
			...
			t[id2Coord(m2).x][id2Coord(m2).y]->fcr->set_fast_line(1);
		}
			...
			t[id2Coord(m3).x][id2Coord(m3).y]->fcr->set_fast_line(0);
			t[id2Coord(m4).x][id2Coord(m4).y]->fcr->set_fast_line(1);


		}
		else if((enable_timer >= (MC1_time+ MC2_time + MC3_time))&& (enable_timer < MC1_time+ MC2_time + MC3_time + MC4_time ) ){
			...
			t[id2Coord(m3).x][id2Coord(m3).y]->fcr->reset_send_enable();
			t[id2Coord(m4).x][id2Coord(m4).y]->fcr->set_send_enable();
			t[id2Coord(m5).x][id2Coord(m5).y]->fcr->set_send_enable();
			t[id2Coord(m6).x][id2Coord(m6).y]->fcr->reset_send_enable();
			t[id2Coord(m7).x][id2Coord(m7).y]->fcr->reset_send_enable();
			t[id2Coord(m8).x][id2Coord(m8).y]->fcr->reset_send_enable();

			t[id2Coord(m4).x][id2Coord(m4).y]->fcr->set_fast_line(0);
			t[id2Coord(m5).x][id2Coord(m5).y]->fcr->set_fast_line(1);


		}
				else if((enable_timer >= (MC1_time+ MC2_time + MC3_time+ MC4_time ))&& (enable_timer < MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time ) ){
			//cout<<" gam set node 13 to enable"<<endl
					...
					t[id2Coord(m4).x][id2Coord(m4).y]->fcr->reset_send_enable();
					t[id2Coord(m5).x][id2Coord(m5).y]->fcr->set_send_enable();
					t[id2Coord(m6).x][id2Coord(m6).y]->fcr->set_send_enable();
					t[id2Coord(m7).x][id2Coord(m7).y]->fcr->reset_send_enable();
					t[id2Coord(m8).x][id2Coord(m8).y]->fcr->reset_send_enable();

			t[id2Coord(m5).x][id2Coord(m5).y]->fcr->set_fast_line(0);
			t[id2Coord(m6).x][id2Coord(m6).y]->fcr->set_fast_line(1);

		}
				else if((enable_timer >= (MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time))&& (enable_timer < MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time + MC6_time ) ){
			//cout<<" gam set node 13 to enable"<<endl
					...
					t[id2Coord(m5).x][id2Coord(m5).y]->fcr->reset_send_enable();
					t[id2Coord(m6).x][id2Coord(m6).y]->fcr->set_send_enable();
					t[id2Coord(m7).x][id2Coord(m7).y]->fcr->set_send_enable();
					t[id2Coord(m8).x][id2Coord(m8).y]->fcr->reset_send_enable();

			t[id2Coord(m6).x][id2Coord(m6).y]->fcr->set_fast_line(0);
			t[id2Coord(m7).x][id2Coord(m7).y]->fcr->set_fast_line(1);


		}
				else if((enable_timer >= (MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time + MC6_time ))&& (enable_timer < MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time + MC6_time + MC7_time ) ){
			//cout<<" gam set node 13 to enable"<<endl
					...
					t[id2Coord(m6).x][id2Coord(m6).y]->fcr->reset_send_enable();
					t[id2Coord(m7).x][id2Coord(m7).y]->fcr->set_send_enable();
					t[id2Coord(m8).x][id2Coord(m8).y]->fcr->set_send_enable();

			t[id2Coord(m7).x][id2Coord(m7).y]->fcr->set_fast_line(0);
			t[id2Coord(m8).x][id2Coord(m8).y]->fcr->set_fast_line(1);


		}
				else if((enable_timer >= (MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time + MC6_time + MC7_time ))&& (enable_timer < MC1_time+ MC2_time + MC3_time + MC4_time + MC5_time + MC6_time + MC7_time + MC8_time) ){
			//cout<<" gam set node 13 to enable"<<endl
			...
			t[id2Coord(m8).x][id2Coord(m8).y]->fcr->set_fast_line(0);
			t[id2Coord(m1).x][id2Coord(m1).y]->fcr->set_fast_line(1);
